  ...
  const content = (
    <motion.div
      ...
      className={cn(
        ...
        !notification.isRead && "bg-indigo-500/5 border-indigo-500/20"
      )}
    >
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
              <div>
                ...
                <p className="text-slate-400 mt-1">
                  {unreadCount > 0 ? (
                    <>
                      Tienes <span className="text-indigo-400">{unreadCount}</span> notificacion{unreadCount !== 1 ? "es" : ""} sin leer
                    </>
                  ) : (
              ...
              {unreadCount > 0 && (
                <Button
                  variant="outline"
                  className="glass border-white/10 text-slate-400 hover:text-white"
